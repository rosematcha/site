    ...
    <div className="page-content">
      <section className="hero">
        <h2 className="hero-title">
          Hi, I’m <span className="gradient-text">Reese!</span>
        </h2>
        <p className="hero-subtitle">
          I build thoughtful tools, make pictures, and help communities thrive.
        </p>
        <div className="hero-actions">
          <Link className="button" to="/projects">View Projects</Link>
          <Link className="button" to="/guestbook">Sign Guestbook</Link>
        </div>
      </section>

      <section className="feature-grid">
        <Link className="feature-card" to="/projects">
          <h3>My Projects</h3>
          <p>Mostly experiments with data viz and personal projects.</p>
        </Link>
        <Link className="feature-card" to="/resume">
          <h3>Resume</h3>
          <p>I do a lot of professional work. Read all about it!</p>
        </Link>
        <a className="feature-card" href="mailto:hi@rosematcha.com">
          <h3>Send An Email</h3>
          <p>For inquiries, opportunities, or just to say hi.</p>
        </a>
      </section>
      ...
      <section>
        ...
        <div className="intro-image-container center mt-2">
          <img src="/img/haruhi.gif" alt="Haruhi Suzumiya dancing" className="intro-gif" />
        </div>
      </section>
    </div>
  );
