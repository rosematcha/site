      ...
      <section className="resume-section">
        ...
        <div className="summary-card">
          <p>
            ...
            creating engaging content, coordinating community initiatives, and delivering excellent
            customer service. Passionate about user-centric design and open technologies.
          </p>
        </div>
      </section>
      ...
      <section className="resume-section hidden">
        ...
        <div className="recommendations">
          <div className="recommendation-card">
            ...
            <p>
              Implemented an inventory system for 500+ items and led data-driven infrastructure
              improvements, significantly enhancing organizational efficiency.
            </p>
          ...
          <div className="recommendation-card">
            <div className="quote-mark">"</div>
            <p>
              Employee of the month four times during tenure at McDonald's, with customers
              specifically requesting my service.
            </p>
          ...
          <div className="recommendation-card">
            <div className="quote-mark">"</div>
            <p>
              Developed bespoke WordPress extensions including a serialized check-in system for
